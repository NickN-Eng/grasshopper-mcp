...
{
    /// <summary>
    /// Grasshopper MCP component used to communicate with the Python server.
    /// </summary>
    public class GrasshopperMCPComponent : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            // Start or stop the server based on the enabled state.
        ...
        /// <summary>
        /// Listener loop that handles incoming connections.
        /// </summary>
