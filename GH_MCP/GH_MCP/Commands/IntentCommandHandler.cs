...
namespace GH_MCP.Commands
{
    ...
    public class IntentCommandHandler
    {
        ...
        /// <summary>
        /// Handle the create pattern command.
        /// </summary>
        ...
        public static object CreatePattern(Command command)
        {
            ...
            foreach (var component in components)
            {
                ...
                // Add a short delay to ensure the component is created.
                Thread.Sleep(100);
            }
            ...
            foreach (var connection in connections)
            {
                try
                {
                    // Check whether source and target component IDs exist.
                ...
                // Add a short delay to ensure the connection is created.
                Thread.Sleep(100);
            }
        ...
        public static object GetAvailablePatterns(Command command)
        {
            ...
            else
            {
                ...
                // IntentRecognizer needs to be extended to support retrieving all patterns.
