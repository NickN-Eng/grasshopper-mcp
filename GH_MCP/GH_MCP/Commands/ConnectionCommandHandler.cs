...
{
    /// <summary>
    /// Handler for component connection commands.
    /// </summary>
    public class ConnectionCommandHandler
    {
        ...
        public static object ConnectComponents(Command command)
        {
            ...
            if (command.Parameters.TryGetValue("sourceParam", out object sourceParamObj) && sourceParamObj != null)
            {
                ...
                // Use fuzzy matching to get a normalized parameter name.
            ...
            // Execute the connection on the UI thread.
            object result = null;
            ...
            RhinoApp.InvokeOnUiThread(new Action(() =>
            {
                try
                {
                    ...
                    // Check whether the source component is an input parameter component.
                    ...
                    // Check whether the target component is an output parameter component.
        ...
        private static IGH_Param GetParameter(IGH_DocumentObject docObj, Connection connection, bool isInput)
        {
            ...
            if (docObj is IGH_Component component)
            {
                ...
                // Check whether the parameter collection is empty.
                if (parameters == null || parameters.Count == 0)
                {
                    return null;
                }
                
                // If there is only one parameter, return it (when no name/index is specified).
        ...
        /// <summary>
        /// Check whether two parameters are compatible.
        /// </summary>
        ...
        private static bool AreParametersCompatible(IGH_Param source, IGH_Param target)
        {
            ...
            // Log parameter type info for debugging.
            ...
            // Check component GUIDs to ensure the connection targets the correct component type.
            ...
            if (sourceDoc != null && targetDoc != null)
            {
                ...
                // If source and target components were found.
                if (sourceComponent != null && targetComponent != null)
                {
                    ...
                    // Special handling for plane-to-geometry connections.
                    ...
                    // If the source is a slider and the target is a circle, ensure the target is the circle component.
                    if (sourceComponent.Name.Contains("Number") && targetComponent.Name.Contains("Circle"))
                    {
                        // Check whether the target is the correct circle component (using GUID or description).
                        ...
                        {
                            // This is the correct circle component (creates a circle).
                            return true;
                        }
                    }
                    
                    // If the source is a plane and the target is a box, allow the connection.
            ...
            // Default to allowing the connection and let Grasshopper decide at runtime.
            return true;
        }

        /// <summary>
        /// Check whether a parameter is numeric.
        /// </summary>
        ...
        /// <summary>
        /// Find the component that owns a parameter.
        /// </summary>
        /// <param name="doc">Document.</param>
        /// <param name="param">Parameter.</param>
        /// <returns>Owning component.</returns>
        ...
        /// <summary>
        /// Check whether a component is a plane component.
        /// </summary>
        /// <param name="component">Component.</param>
        /// <returns>Whether it is a plane component.</returns>
        private static bool IsPlaneComponent(IGH_Component component)
        {
            ...
            // Check the XY Plane component GUID.
        ...
        /// <summary>
        /// Check whether a component requires a plane input.
        /// </summary>
        /// <param name="component">Component.</param>
        /// <returns>Whether it requires a plane input.</returns>
        private static bool RequiresPlaneInput(IGH_Component component)
        {
            if (component == null)
                return false;
                
            // Check for inputs named "Plane" or "Base".
