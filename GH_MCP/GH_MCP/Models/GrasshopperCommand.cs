...
{
    /// <summary>
    /// Represents a command sent from the Python server to Grasshopper.
    /// </summary>
    public class Command
    {
        ...
        public T GetParameter<T>(string name)
        {
            if (Parameters.TryGetValue(name, out object value))
            {
                ...
                {
                    // If this is a Newtonsoft.Json.Linq.JObject, try converting.
                    if (value is Newtonsoft.Json.Linq.JObject jObject)
                    {
                        return jObject.ToObject<T>();
                    }
                    
                    // If this is a Newtonsoft.Json.Linq.JArray, try converting.
            ...
            // If the parameter cannot be retrieved or converted, return the default value.
            return default;
        }
    }

    /// <summary>
    /// Represents a response sent from Grasshopper to the Python server.
    /// </summary>
